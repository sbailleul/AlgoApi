...
namespace AlgoApi.Test
{
    ...
    public class EventsTests
    {
        ...
        public void TestEventRaising()
        {
            ...
            worker.WorkPerformed += ( sender,  e) => Console.WriteLine("H : " + e.Hours + " WT : " + e.WorkType); // OR new EventHandler<WorkPerformedEventArgs>(Worker_WorkPerformed) OR delegate(object sender, WorkPerformedEventArgs e) {...} OR (object sender, WorkPerformedEventArgs e) => {};
