...
namespace AlgoApi.LanguageTest.EnumerableTests
{
    ...
    public class DictionariesTests
    {
        ...
        public void Dictionary()
        {
            var dic = new Dictionary<string, Ingredient>(
                new DynamicEqualityComparer<string>((a, b) => string.Equals(a, b, StringComparison.OrdinalIgnoreCase),
                    a => a.ToUpper().GetHashCode()))
            {
        ...
        public void SortedDictionary()
        {
            ...
            foreach (var el in dic) Console.WriteLine(el);
        }
    ...
    public class DynamicEqualityComparer<T> : IEqualityComparer<T>
    {
        ...
        private Func<T, int> HashFunc { get; }
